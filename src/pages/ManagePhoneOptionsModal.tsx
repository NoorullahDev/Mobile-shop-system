...
interface ManagePhoneOptionsModalProps {
  open: boolean;
  onClose: () => void;
}
...
const OPTION_TYPES = [
  ...
  { id: "camera_condition", label: "Camera Condition" },
  { id: "face_id", label: "Face ID / Fingerprint" },
  { id: "speaker", label: "Speaker" },
  { id: "charger", label: "Charger" },
  { id: "box_condition", label: "Box" },
];

export function ManagePhoneOptionsModal({ open, onClose }: ManagePhoneOptionsModalProps) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      // In a real app, you might want to show this error in the delete modal
      console.error(err);
      alert(String(err));
    }
  };
  ...
  return (
    <>
      <Modal
        ...
        subtitle="Add, edit, or remove options for the phone form dropdowns."
        onClose={() => {
          onClose();
          handleCancelEdit();
        }}
